...
import com.example.test.common.cloudinary.CloudinaryHelper;
        ...
        return productEntities.map(
                product -> {
                    ...
                    return ProductDtoResponse.builder()
                            ...
                            .name(product.getName())
                            .price(attribute.getPrice())
                            .brand(brandsEntityMap.get(product.getBrandId()) != null ? brandsEntityMap.get(product.getBrandId()).getName() : null)
                            .code(product.getCode())
                            .view(product.getView())
                            .description(product.getDescription())
                            .image(imageMap.get(product.getId()) != null ? imageMap.get(product.getId()).getImageLink() : null)
                            .discount(salesEntityMap.get(product.getSaleId()) != null ? salesEntityMap.get(product.getSaleId()).getDiscount() : null)
                            .isActive(product.getIsActive())
                            .liked(Boolean.FALSE)
                            .build();
                }
