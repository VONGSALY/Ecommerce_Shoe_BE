...
import com.example.test.dto.order.MonthSynthesis;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT new com.example.test.dto.order.MonthSynthesis(MONTH(o.createDate), COUNT(o.id), SUM (o.total)) FROM Order o WHERE o.orderStatusId = 4 AND YEAR(o.createDate) = :year GROUP BY MONTH(o.createDate) ORDER BY SUM (o.total) DESC")
