...
public class MailUtil {
    private static final String email = "toto.vse2@gmail.com";

    private static final String password = "lbks yxfg fiis onhg";
    ...
    public static void sendEmail(Voucher voucher, Order order) throws MessagingException {
        ...
        Message msg = new MimeMessage(session);
        msg.setFrom(new InternetAddress("toto.vse2.ptit.edu.vn", false));
    ...
    public static void sendmailForgotPassword(String receive, String password) throws MessagingException {
        ...
        Session session = Session.getInstance(props, new Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("toto.vse2@gmail.com", "lbks yxfg fiis onhg");
            }
        });
        Message msg = new MimeMessage(session);
        msg.setFrom(new InternetAddress(email, false));
